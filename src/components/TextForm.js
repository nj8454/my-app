  ...
  const [text, setText] = useState('');
    ...
    return (
        ...
        <div className="container" style={{color: props.mode==='dark'?'white':'black'}}>
            <h1>{props.heading}</h1>
            <div className="mb-3">
            <textarea className="form-control" value= {text} onChange={handleOnchange} style={{backgroundColobar: props.mode==='dark'?'grey':'white', color: props.mode==='dark'?'black':'white'}} id="myBox" rows="8"></textarea>
            </div>
